...
- [ ] Change sensor type (Android only)
- [ ] Add video settings (Android only)
- [ ] Use Pigeon on iOS only
- [x] Return list of all available cameras (iOS)
- [x] Add analysis mode for iOS only
- [x] Tap to focus on a point (iOS only)
