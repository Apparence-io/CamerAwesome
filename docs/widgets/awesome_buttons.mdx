...
Take a picture when in Photo mode or start/stop recording when in Video mode.
...
When taking a picture, enable or disable the save of the current location in the exif metadata.
