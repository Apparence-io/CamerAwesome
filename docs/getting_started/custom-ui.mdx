...
If `CamerAwesomeBuilder.awesome()` doesn't fit your needs in terms of layout, you can create your own UI using the `CameraAwesomeBuilder.custom()` constructor.
...
Many of them use the `AwesomeTheme` provided to `CamerAwesomeBuilder`.
