...
CameraAwesomeBuilder.custom(
  pathBuilders: PathBuilders.imageAndVideo(
...
| Method                           | Comment | 
|----------------------------------|---------|
| **pathBuilders**           | Define if you want to take photos, videos or both and where to save them  |
...
|**Get** original PathBuilders|`state.pathBuilders`|
