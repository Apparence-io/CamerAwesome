...
- (void)takePhotoRequests:(NSDictionary<PigeonSensor *, NSString *> *)requests completion:(void (^)(NSNumber *_Nullable, FlutterError *_Nullable))completion;
- (void)recordVideoRequests:(NSDictionary<PigeonSensor *, NSString *> *)requests options:(nullable VideoOptions *)options completion:(void (^)(FlutterError *_Nullable))completion;
