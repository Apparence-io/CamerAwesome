...
/// @return `nil` only when `error != nil`.
- (nullable NSArray<NSString *> *)requestPermissionsWithError:(FlutterError *_Nullable *_Nonnull)error;
/// @return `nil` only when `error != nil`.
...
- (void)setRecordingAudioModeEnableAudio:(NSNumber *)enableAudio error:(FlutterError *_Nullable *_Nonnull)error;
/// @return `nil` only when `error != nil`.
...
- (void)setExifPreferencesExifPreferences:(ExifPreferences *)exifPreferences error:(FlutterError *_Nullable *_Nonnull)error;
